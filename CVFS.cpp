...
void InitialiseSuperBlock()
{
    ...
    SUPERBLOCKobj.TotaInodes = MAXINODE;
    ...
    while(1)
    {
        ...
        else if(count == 2)
        {
            ...
            else if(strcmp(command[0],"close") == 0)
            {
                ...
                if(ret == -1)
                        printf("ERROR : There is such file \n");
                continue;
            }
        ...
        else if(count == 3)
        {
            if(strcmp(command[0],"create") == 0)
            {
                ...
                if(ret >= 0)
                    printf("File is successfully created with the discriptor : %d\n",ret);
                if(ret == -1)
                    printf("ERROR : Incorrect parameters \n");
                if(ret == -2)
            ...
            else if(strcmp(command[0],"open") == 0)
            {
                ...
                if(ret >= 0)
                    printf("File is successfu+lly opened with the discriptor : %d\n",ret);
                if(ret == -1)
                    printf("ERROR : Incorrect parameters \n");
                if(ret == -2)
...
/*      https://man7.org/linux/man-pages/man2/stat.2.html
    ...
    main()
    DisplayHelp()
    man()   works only in linux (use before wnter command in linux )
